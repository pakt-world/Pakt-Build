...
const JobDescription = ({ form }: JobDescriptionProps): ReactElement => {
	return (
		<div className="flex flex-col gap-2">
			<h3 className="text-lg font-bold text-black sm:font-medium">Job Description</h3>
			<div className="relative">
				<textarea
					id="description"
					maxLength={400}
					{...form.register("description")}
					className="w-full rounded-lg border border-blue-lighter bg-input-bg p-4 focus:outline-none"
					placeholder="Enter job description"
					rows={3}
				/>
				<div className="-mt-1 ml-auto w-fit text-sm text-body">{form.watch("description")?.length}/400</div>

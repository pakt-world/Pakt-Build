...
import { ClientJobCancellationSuccessfullyRequested4Desktop } from "./request-success";
...
export const ClientRequestJobCancellation4Desktop: FC<RequestJobCancellationProps> = ({
	jobId,

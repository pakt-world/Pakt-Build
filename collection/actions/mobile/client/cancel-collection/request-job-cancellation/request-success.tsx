...
export const ClientJobCancellationSuccessfullyRequested4Mobile: FC<{
		...
		<div className="size-full overflow-y-auto">
			<div className="flex h-full items-center justify-center px-4">
				<div className="flex flex-col items-center gap-9">
					...
					<p className="text-center text-lg text-body">A cancel request has been sent to the talent.</p>

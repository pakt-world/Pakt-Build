...
export const TalentJobCancellationSuccessfullyRequested4Mobile: FC<{ closeModal: () => void }> = () => {
	const router = useRouter();
	return (
		<div className="fixed top-[70px] flex h-[calc(100dvh-134px)] w-full items-center justify-center px-4">
			<div className="flex flex-col items-center gap-9">
				...
				<p className="text-center text-lg text-body">
					A cancel request has been sent <br /> to the client.
				</p>

...
import { TalentJobCancellationSuccessfullyRequested4Mobile } from "./request-success";
...
export const RequestJobCancellation: FC<RequestJobCancellationProps> = ({
	...
	if (isSuccess) {
		return <TalentJobCancellationSuccessfullyRequested4Mobile closeModal={closeModal} />;
	}
	...
	return (
		<div className="size-full overflow-y-auto">
			...
			<div className="flex h-auto grow flex-col gap-6 px-4 py-6">

...
export const TalentAcceptJobCancellationRequest4Mobile: FC<AcceptJobCancellationProps> = ({
	...
	return (
		<div className="size-full overflow-y-auto">
			...
			{/* <div className="flex overflow-y-auto h-full grow flex-col gap-10 px-4 py-6 pb-[100px]"> */}

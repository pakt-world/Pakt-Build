...
export const OpenHeader = ({
	...
	return (
		<div className="sticky left-0 top-0 z-[99] flex w-full items-end gap-4 rounded-2xl border border-amount_badge-m bg-white p-6">
			...
			<div className="relative flex grow flex-col gap-1">
				...
				<div className="flex h-11 gap-2 rounded-lg border border-line bg-input-bg py-2">
					<NumericInput
						type="text"

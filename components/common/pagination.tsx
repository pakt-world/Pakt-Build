	...
	return (
		<div className="flex items-center justify-between gap-2 text-sm">
			...
			<div className="flex items-center gap-2">
				<button
					className="rounded-lg p-1 px-2 text-primary hover:bg-[#3055B31A]"
					onClick={() => {
				...
				{leftPages.length > 0 &&
					leftPages.map((page) => (
						<button
							key={page}
							className="rounded-lg bg-white p-1 px-3 text-sm text-primary hover:bg-[#3055B31A]"
							onClick={() => {
								setCurrentPage(page);
							}}
							aria-label="Back"
				...
				{rightPages.length > 0 &&
					rightPages.map((page) => (
						<button
							key={page}
							className={`rounded-lg p-1 px-3 text-sm text-primary hover:bg-[#3055B31A] ${currentPage === page ? "bg-[#3055B31A]" : "bg-white"}`}
							onClick={() => {
								setCurrentPage(page);
							}}
							aria-label="Back"

...
export type CombinedAttachmentType = Partial<AttachmentsResponseProps> & Partial<AttachmentsSendingProps>;
...
export type CombinedMessageProps = Partial<MessageResponseProps> & Partial<TemporaryBubbleProps>;
...
export type CombinedConversationResponseProps = Partial<ConversationResponseProps> & Partial<PopUpChatDataProps>;

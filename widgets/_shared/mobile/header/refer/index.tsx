...
export function ReferralPage4Mobile(): React.ReactElement {
	...
	return (
		<div className="relative z-50 flex w-full flex-col bg-white">
			<div
				className="!sticky !top-[70px] left-0 z-10 flex w-full flex-row items-center gap-4 bg-brand_gradient p-4 text-xl font-bold
					text-white"
			>
				<Button
					className="m-0 p-0"
			...
			{!isSentEmail ? (
				<div className="flex h-full max-w-full flex-col gap-2 overflow-y-auto px-5 py-6">
					...
					<div className="my-4 w-full rounded-2xl border border-primary-darker bg-secondary p-4">

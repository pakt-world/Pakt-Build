...
import { TransactionStatus } from "../../../../_shared/transactions/status";
...
export const TABLE_COLUMNS = ({ snowtraceBaseUrl }: TableColumnsProps): Array<ColumnDef<WalletTransactionsProps>> => [
	{
		header: "Date",
	...
	},
	{
		...
		cell: ({ getValue }) => <TransactionStatus status={getValue<TransactionStatusEnums>()} />,
	},
	{
		header: " ",
		...
		cell: ({ getValue }) => {
			...
			return transactionHash !== "" ? (
				<Link
					href={`${snowtraceBaseUrl}/tx/${transactionHash as string}`}
					target="_blank"

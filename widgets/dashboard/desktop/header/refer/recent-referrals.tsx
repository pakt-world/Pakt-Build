...
const RecentReferral = ({ referral }: RecentReferralProps): ReactElement => {
	return (
		<div className="flex w-full flex-row justify-between rounded-2xl border border-line bg-refer-bg px-4 py-2">
			<div className="flex flex-row gap-2">
				...
				<span className="my-auto items-center">
					<h3 className="text-lg font-bold text-title">{referral?.name}</h3>

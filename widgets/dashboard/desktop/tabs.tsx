...
export const DashboardTabs4Desktop = (): JSX.Element => {
	...
	return (
		<div className="flex flex-1 overflow-y-auto overflow-x-hidden sm:h-full sm:basis-0">
			<Tabs
				tabs={[
					{
						label: "Your Feed",
				...
				className=""
				tabListClassName="transition-all border-t-0 mb-4 duration-300 ease-in-out -webkit-transition-all -moz-transition-all -o-transition-all"
				tabContentContainerClassName="!z-30 transition-all duration-300 ease-in-out -webkit-transition-all -moz-transition-all -o-transition-all sm:!mt-0"
			/>
		</div>
	);
};
